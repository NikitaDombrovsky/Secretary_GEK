...
namespace ClientSecretaryGEK.Network.Reviewer
{
    ...
    {
            public ReviewerTable(int Id, string post, string workplace, string id_speciality, string id_pd) //
            {
                this.Id = Id;
                this.Должность = post;
    ...
    public class ReviewerTableALL
    {
        public ReviewerTableALL(int Id, string surname, string name, string patronymic, string post, string workplace, string name_speciality) //
        {
            this.Id = Id;
